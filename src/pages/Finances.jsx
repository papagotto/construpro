        ...
        <div className="space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap gap-3">
                    <button className="px-4 py-2 text-sm font-bold text-emerald-600 bg-white dark:bg-slate-900 border border-emerald-200 dark:border-emerald-900/30 rounded-lg hover:bg-emerald-50 transition-all shadow-sm">
                        + Nuevo Ingreso
                    </button>
                    <button className="px-4 py-2 text-sm font-bold text-red-600 bg-white dark:bg-slate-900 border border-red-200 dark:border-red-900/30 rounded-lg hover:bg-red-50 transition-all shadow-sm">
                        + Nuevo Gasto
                    </button>
                    <button className="bg-primary hover:bg-primary/90 text-white px-5 py-2.5 rounded-lg text-sm font-bold shadow-sm transition-all active:scale-95">
                        Conciliar Bancos
                    </button>
                </div>
            </div>
            ...
            {/* Filters Bar */}
            <div className="bg-white dark:bg-surface-dark p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-wrap items-center gap-4">
                <div className="flex-1 min-w-[240px] relative">
                    <span className="material-icons absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-lg">search</span>
                    <input 
                        type="text" 
                        placeholder="Buscar por concepto o ID..." 
                        className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-800/50 border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/20"
                    />
                </div>
                <select className="bg-slate-50 dark:bg-slate-800/50 border-none rounded-lg px-4 py-2 text-sm font-medium focus:ring-2 focus:ring-primary/20">
                ...
                <div className="relative">
                    <input 
                        ...
                        className="bg-slate-50 dark:bg-slate-800/50 border-none rounded-lg px-4 py-2 text-sm font-medium focus:ring-2 focus:ring-primary/20"
                    />
                </div>
            </div>
