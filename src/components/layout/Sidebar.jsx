...
const Sidebar = () => {
            ...
            return (
                <div key={item.name} className="relative">
                    ...
                    >
                        ...
                        <span
                            className={`material-icons text-sm transform transition-transform duration-200 ${isOpen ? 'rotate-180' : ''
                                }`}
                        >
                            expand_more
                        </span>
    ...
    return (
        <aside className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-surface-light dark:bg-surface-dark border-r border-slate-200 dark:border-slate-800 hidden md:block overflow-y-auto">
